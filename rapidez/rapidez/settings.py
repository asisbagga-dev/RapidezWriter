"""
Django settings for rapidez project.
...
SECRET_KEY = '#)xgga688w+sj=%&u=hupbrffk9_ptcp&_5y6n6xp!$r)t_q)m'
...
WSGI_APPLICATION = 'rapidez.wsgi.application'
